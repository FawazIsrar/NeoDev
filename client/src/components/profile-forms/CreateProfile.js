    ...
    <main className="flex-grow pt-24 pb-xl px-margin-mobile md:px-margin-desktop relative z-10 w-full max-w-[1440px] mx-auto min-h-[calc(100vh-80px)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
        ...
        <div className="md:col-span-12 mb-lg">
          ...
          <h1 className="font-headline-lg-mobile md:font-headline-lg text-on-surface">Create Your Profile</h1>
          <p className="font-sans text-body text-on-surface-variant mt-xs">Let's get some information to make your profile stand out.</p>
        </div>
